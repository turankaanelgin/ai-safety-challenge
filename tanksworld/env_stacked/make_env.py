...
from tanksworld.env_stacked.env import TanksWorldEnv
...
def make_env(friendly_fire=True, take_damage_penalty=True, kill_bonus=True, death_penalty=True,
	training_tanks=[], static_tanks=[], random_tanks=[], disable_shooting=[], reward_weight=1.0, penalty_weight=1.0, **kwargs):
	return TanksWorldEnv(cfg.args.exe,
		...
		training_tanks=training_tanks,			# do you get -1 for dying

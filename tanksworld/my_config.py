...
parser.add_argument('--n-input-enable', type=int, default=1, help='number of tanks input give for the algorithm')
parser.add_argument('--timestep', type=int, default=1000000)
parser.add_argument('--save-freq', type=int, default=10000)
parser.add_argument('--n-episode', type=int, default=5)
parser.add_argument('--n-envs', type=int, default=1)
parser.add_argument('--env-timeout', type=int, default=500, help='Environments max timestep per episode')
